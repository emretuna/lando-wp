											...
											if ( learndash_is_admin_user() ) :
												...
												<div class="ld-bootcamp__license">
													...
													<div class="ld-bootcamp__license--fields">
															...
															<input type="email" readonly="readonly" value="<?php echo empty( $this->license_info['email'] ) ? '' : esc_html( $this->license_info['email'] ); ?>" id="ld-bootcamp__email" name="nss_plugin_license_email_sfwd_lms" />
														</div>
														<div class="ld-bootcamp__license--fields">
															<label for="ld-bootcamp__license-key"><?php echo esc_html_x( 'Enter your license key here', 'License key', 'learndash' ); ?></label>
															<input type="text" readonly="readonly" value="<?php echo empty( $this->license_info['license'] ) ? '' : esc_html( $this->license_info['license'] ); ?>" id="ld-bootcamp__license-key" name="nss_plugin_license_sfwd_lms" />
														</div>
